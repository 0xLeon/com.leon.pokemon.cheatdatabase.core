<ul class="breadCrumbs">
	...
	{if $entry|isset && $showEntryForm|isset}
		<li><a href="index.php?page=CheatDatabaseEntry&amp;entryID={@$entry->entryID}{@SID_ARG_2ND}"><img src="{icon}cheatDatabaseEntryS.png{/icon}" alt="" /> <span>{$entry->getName()}</span></a> &raquo;</li>
	{/if}
</ul>
